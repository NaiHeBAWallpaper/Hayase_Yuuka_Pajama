...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Miracle.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	{
		...
		startTimes: [500],
		dialog: {
			Japanese: ["せ、先生？こんな時間にどうして……？"],
			English: ["Teacher? Why are you here at this hour...?"],
			Chinese: ["老、老师？这个时间点您为什么会在这……？"]
		}
	},
	{
		time: 18000,
		count: 3,
		startTimes: [500, 6000, 10300],
		dialog: {
			Japanese: [
				"え、えっと……これは、その……",
				"ちょっと寝付けなくて、散歩に出たら……",
				"そこの貼り紙の「エンジェルチキン」が目に入ったんです……。"
			],
			English: [
				"W-well... This is, um...",
				"I couldn't sleep, so I went for a walk...",
				"Then I noticed the poster for 'Angel Chicken'..."
			],
			Chinese: [
				"那、那个……这是、那个……",
				"我有点睡不着、出来散步的时候……",
	...
	},
	{
		time: 19000,
		count: 3,
		startTimes: [500, 4800, 9300],
		dialog: {
			Japanese: [
				"だ、だって、仕方ないでしょう？",
				"この時間のエンジェルチキンは、揚げたてなんです！",
				"あっつあつで肉汁たっぷりなんですから！買わない手はありません！"
			],
			English: [
				"B-but, what else could I do?",
				"The Angel Chicken is freshly fried at this hour!",
				"It's piping hot and full of juices! There's no way I could resist!"
			],
			Chinese: [
				"因、因为、这也是没办法的吧？",
				"这个时间有刚炸好的、天使鸡啊！",
				"热乎乎而且冒着汁水！根本没有不买的理由啊！"
			]
		}
	},
	{
		...
		dialog: {
			...
			English: [
				"S-so it's not like... I'm having",
				"midnight snacks every single day or anything..."
			],
			Chinese: [
				"所、所以那个……也不是、每天都、",
				"吃宵夜、啦……"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"Um... if you'd like,",
				"would you like a bite too, teacher?"
			],
			Chinese: [
				"那那个……要不、",
				"老师也、吃一口？"
...
const HITBOX = {
	headpat: { xMin: 1100, xMax: 2200, yMin: -200, yMax: 600 },
	voiceline: { xMin: 700, xMax: 1970, yMin: 900, yMax: 1800 }
};
